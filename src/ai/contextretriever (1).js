  ...
  static retrieve(transcript, rewrittenQuery, resolvedRef, storeSnapshot, convContext) {
    ...
    if (!resData) {
      ...
      return {
        ...
        memoryMessage: "Đồng chí có thể hỏi về: Báo cáo chính trị Đại hội XIV (GDP, mục tiêu 2030/2045, bộ máy, xây dựng Đảng); Báo cáo 40 năm đổi mới 1986–2026 (thành tựu, bài học, thể chế); NQ 71 về giáo dục đào tạo (ngân sách, top ĐH, phụ cấp GV); Phụ lục 5 về xây dựng Đảng nhiệm kỳ XIII; Tài liệu hỏi-đáp Văn kiện XIV; Báo cáo tổng kết 15 năm Điều lệ Đảng (đảng viên, tổ chức cơ sở, kỷ luật); hoặc các nghị quyết số 57, 59, 66, 68, 70, 71, 72, 79, 80.",
    ...
    // A. Direct Answer
    let directAnswer = `Nghị quyết số <b>${resData.number}</b> của ${resData.issuedBy || 'Ban Chấp hành Trung ương Đảng'} ban hành ngày ${resData.date || 'đang cập nhật'} tập trung vào chủ đề: <i>"${resData.title}"</i>. `;
