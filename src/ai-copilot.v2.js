    ...
    const overlayHTML = `
      <div id="apple-ai-overlay" class="apple-ai-overlay" style="display:none;">
        ...
        <div class="apple-ai-content">
          ...
          <div class="apple-ai-input-wrapper" style="position:relative; width:100%; max-width:640px; margin:20px auto 0; display:none; flex-shrink:0;">
